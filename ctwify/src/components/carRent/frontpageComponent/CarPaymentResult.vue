  ...
  <v-container class="py-6" max-width="1000">
    ...
    <v-card class="soft-card mb-4" elevation="2" rounded="xl">
      <v-card-title class="text-h6 d-flex align-center">
        <v-icon class="mr-2" color="deep-orange-accent-3">mdi-car-info</v-icon>
        ...
        <v-row>
          <v-col cols="12" md="6">
            <v-list density="comfortable" class="flat-list">
              <v-list-item>
                <template #prepend>
                  <v-icon color="deep-orange">mdi-identifier</v-icon>
                </template>
              ...
              <v-list-item>
                <template #prepend>
                  <v-icon color="deep-orange">mdi-calendar-start</v-icon>
                </template>
                <v-list-item-title class="kv">
              ...
              <v-list-item>
                <template #prepend>
                  <v-icon color="deep-orange">mdi-calendar-end</v-icon>
                </template>
                <v-list-item-title class="kv">
              ...
              <v-list-item>
                <template #prepend>
                  <v-icon color="deep-orange">mdi-store-marker</v-icon>
                </template>
                <v-list-item-title class="kv">
              ...
              <v-list-item v-if="detail.businessHours">
                <template #prepend>
                  <v-icon color="deep-orange">mdi-clock-outline</v-icon>
                </template>
                <v-list-item-title class="kv">
          ...
          <v-col cols="12" md="6">
            <v-list density="comfortable" class="flat-list">
              ...
              <v-list-item>
                <template #prepend>
                  <v-icon color="deep-orange">mdi-label</v-icon>
                </template>
                <v-list-item-title class="kv">
              ...
              <v-list-item>
                <template #prepend>
                  <v-icon color="deep-orange">mdi-car-info</v-icon>
                </template>
                <v-list-item-title class="kv">
              ...
              <v-list-item>
                <template #prepend>
                  <v-icon color="deep-orange">mdi-palette</v-icon>
                </template>
                <v-list-item-title class="kv">
              ...
              <v-list-item>
                ...
                <v-list-item-title class="kv">
                  車輛總金額：<span class="value">
                    NT$ {{ formatAmount(detail.totalAmount) }}
                  </span>
                </v-list-item-title>
              </v-list-item>
