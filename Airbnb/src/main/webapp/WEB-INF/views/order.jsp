...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <ul class="navbar-nav ms-auto" id="afterLogin">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="http://localhost:8080/Airbnb/JSP/beforOrderConfirm">我的訂單</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container" style="margin-bottom: 200px;">
        <div class="row mt-5">
            <div class="col-12">
                <h2 class="text-center text-danger mb-4"><i class="fa-solid fa-circle-check"></i> 訂單已成立！請於入住時現金付款</h2>
            </div>
        </div>
                ...
                <div class="card room-card mx-auto">
                    <div class="card-body">
                        ...
                        <ul class="room-info-list">
                            <li><i class="fa-solid fa-user"></i> 訂購人：<span>${username}</span></li>
                            <li><i class="fa-solid fa-house"></i> 房名：<span>${house_name}</span></li>
                            <li><i class="fa-solid fa-calendar-days"></i> 入住：<span>${checkin_date} ～ ${checkout_date}</span></li>
                            <li><i class="fa-solid fa-location-dot"></i> 地址：<span>${address}</span></li>
                            <li><i class="fa-solid fa-phone"></i> 電話：<span>${tel}</span></li>
                            <li><i class="fa-solid fa-bed"></i> 房型：<span>${bed}</span></li>
                        ...
                        <div class="room-btns d-flex gap-2">
                            <a href="http://localhost:8080/Airbnb/index.html" class="btn btn-outline-secondary w-100"><i class="fa-solid fa-arrow-left"></i> 返回首頁</a>
                        </div>
                    </div>
                </div>
            </div>
